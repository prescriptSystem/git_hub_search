...
class RepositoryAdapter(private val repositories: List<Repository>) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.apply {
            name.text = repositories[position].name
            //htmlUrl.text = repositories[position].htmlUrl
        }
        ...
        holder.htmlUrl.setOnClickListener {
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        val name: TextView
        val htmlUrl: ImageView


        init {
            name = view.findViewById(R.id.tv_repository)
            htmlUrl = view.findViewById(R.id.iv_share)
